...
import (
	...
	mock_gateway "github.com/slinkeres/ozontask/internal/gateway/mock"
	mock_service "github.com/slinkeres/ozontask/internal/service/mock"
...
func TestCommentsService_CreateComment(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			args:      args{comment: defaultComment},
			want:      FuncRes{com: models.Comment{}, err: ce.CustomError{}},
